...
insert into ITEM (ID, QUANTITY, TASK_ID, CATEGORY, DESCRIPTION, PRICE) values
    (300012, 2, 7992, 'Labour', 'Labour', 15.00),
    (300013, 1, 7992, 'Parts', 'Kitchen Sink', 100),
    (300014, 2, 7992, 'Other', 'Food when working on site', 9.5),
    (300015, 15, 7384, 'Labour', 'Labour', 15.00),
    (300016, 1, 7384, 'Parts','Mira Excel Shower EV Valve & Kit All Chrome', 288.5),
    (300017, 1, 7384, 'Parts', 'Novellini Cu1407011 30 Custom Shower Tray White 1400mm x 700mm', 343.45),
    (300018, 1, 7384, 'Parts','iflo ABS Capped Slimline Stone Shower Tray 900mm x 900mm', 120.83),
    (300019, 2, 7384, 'Parts','Form 400 Hand Basin Unit/Odessa Oak ', 254.05),
    (300020, 2, 7384, 'Parts','Roca 32778A000 Dama-N Compact Basin 1 Tap Hole 400mm x 320mm ', 100.72),
    (300021, 1, 7384, 'Parts', 'Roca A80178C004 Dama N Compact Soft Close Seat W ', 120.87),
    (300022, 1, 7384, 'Parts','IFLO CASCADA WC PACK', 170.23),
    (300023, 1, 7384, 'Parts','Dudley Tri-Shell Low Level Cistern', 89.45),
    (300024, 1, 7384, 'Materials','4TRADE Frame Silicone Sealant Clear', 4.15),
    (300025, 1, 7384, 'Materials','Pro Flexible Grey Tile Adhesive', 13.14),
    (300026, 2, 1233, 'Parts','Honeywell 10 Year Battery Smoke Alarm XS100', 19.12),
    (300027, 1, 1233, 'Labour','Labour', 15.00),
    (300028, 7, 3542, 'Parts','4Trade Gu10 5W LED', 5.99),
    (300029, 1, 3542, 'Labour', 'Labour', 15.00),
    (300030, 2, 4689, 'Labour','Labour', 15.00),
    (300031, 1, 4689, 'Parts','Kitchen Sink', 100),
    (300032, 1, 7384, 'Materials','Grohe Rapido Shower Valve', 5.99),
    (300033, 1, 7384, 'Materials','4TRADE Frame Silicone Sealant Clear', 4.15),
    (300034, 1, 7384, 'Materials','Pro Flexible Grey Tile Adhesive', 13.14),
    (300035, 1, 7384, 'Parts','Iflo Architect + Fixed Drench Shower Head Thermostatic Bar Mixer Shower', 24.99),
    (300036, 1, 7384, 'Parts', 'Croydex Shower Curtain Plain White', 28.99),
    (300037, 1, 7384, 'Parts','iflo Rapid Secure Shower Fixing Kit', 21.66),
    (300038, 1, 7384, 'Parts','iflo Shower Riser Rail Chrome 650mm', 191.14),
    (300039, 1, 7384, 'Parts', 'Domed Chrome Shower Tray Waste 35 mm', 13.33),
    (300040, 1, 7384, 'Labour', 'Fitting Shower', 20),
    (300041, 1, 7384, 'Parts','Twyfords FC1271WH Belfast Sink White 610 x 455 x 255mm', 49.99),
    (300042, 1, 7384, 'Materials','McAlpine ASC10-SP Tubular Swivel Sink Trap 38mm', 39.99),
    (300043, 1, 7384, 'Materials','4Trade Chrome Basin/Sink Tap Heads', 20.99),
    (300044, 1, 7384, 'Parts','1 1/2in Double Bowl Sink Kit SK2', 24.99);
